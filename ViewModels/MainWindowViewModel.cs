...
using LabMileshko7.Models;
using Avalonia.Media;

namespace LabMileshko7.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Безбородов Сергей Максимович","0","1","2","1","2","1","2",false),
                new Note("Николаев Алексей Дмитриевич","2","2","2","2","1","2","2",false),
                new Note("Ожгибесов Владислав Александрович","2","0","1","2","2","2","1",false),
                new Note("Шиян Илья Иванович","1","2","1","2","2","1","1",false),
            };
        }
